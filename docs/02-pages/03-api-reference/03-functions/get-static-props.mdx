...
| `preview`          | （`draftMode`は非推奨）`preview`は、ページが[プレビューモード](/docs/pages/building-your-application/configuring/preview-mode)の場合は`true`、そうでない場合は`false`です。                                                                                                                                                                                                                                                                                          |
| `previewData`      | （`draftMode`は非推奨）`setPreviewData`によって設定された[プレビュー](/docs/pages/building-your-application/configuring/preview-mode)データ。                                                                                                                                                                                                                                                                                                                              |
| `draftMode`        | ページが[ドラフトモード](/docs/pages/building-your-application/configuring/draft-mode)の場合は`true`、そうでない場合は`false`です。                                                                                                                                                                                                                                                                                                                                         |
