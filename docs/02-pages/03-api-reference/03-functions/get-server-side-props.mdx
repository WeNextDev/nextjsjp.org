...
| `preview`       | （`draftMode`で非推奨）ページが[プレビューモード](/docs/pages/building-your-application/configuring/preview-mode)の場合は`true`、そうでない場合は`false`。                                          |
...
| `draftMode`     | ページが[ドラフトモード](/docs/pages/building-your-application/configuring/draft-mode)の場合は`true`、そうでない場合は`false`。                                                                         |
