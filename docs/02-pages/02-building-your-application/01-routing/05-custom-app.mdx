...
**このパターンは推奨しません。** 代わりに、[App Routerへの段階的な移行](/docs/app/building-your-application/upgrading/app-router-migration)を検討してください。これにより、[ページとレイアウト](/docs/app/building-your-application/routing/layouts-and-templates)のデータをより簡単にフェッチできます。
