...
**このパターンの使用はお勧めしません。** 代わりに、[段階的に App Router を採用](/docs/app/building-your-application/upgrading/app-router-migration)することを検討してください。これにより、[ページとレイアウト](/docs/app/building-your-application/routing/layouts-and-templates)のデータをより簡単にフェッチできます。
