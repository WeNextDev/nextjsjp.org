...
| 導入時期：`v12.2.0` | ミドルウェアが安定版に、[アップグレードガイド](/docs/messages/middleware-upgrade-guide)を参照 |
| 導入時期：`v12.0.9` | Edgeランタイムでの絶対URLの強制（[PR](https://github.com/vercel/next.js/pull/33410)） |
